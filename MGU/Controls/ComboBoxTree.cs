 ...
 * Original code by Gabe Anguiano
 *
...
namespace Verlinea.ComboBoxTree
{
	...
	{
		public delegate void MyEvent(int id);

		public event MyEvent NodeSelected;
		...
		public TreeNode SelectedNode 
		{
			...
			set 
			{
				...
				if (value != null)
					this.TreeViewNodeSelect(null, null);
			}
		}	
		...
		public ComboBoxTree() 
		{
			...
			this.tbSelectedValue.BackColor = System.Drawing.SystemColors.Window;
		...
		{
			if (this._absoluteChildrenSelectableOnly && this.tvTreeView.SelectedNode.Nodes.Count != 0)
				return;
			tbSelectedValue.Text = this.tvTreeView.SelectedNode.Text;
			this.ToggleTreeView(sender,null);
			if (this.NodeSelected != null)
				NodeSelected((int)this.tvTreeView.SelectedNode.Tag);
		}
